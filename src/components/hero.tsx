...
// Camada fixa: o hero ocupa a primeira tela e fica preso enquanto o conteúdo
// desliza por cima dele (o resto da página tem fundo próprio e z-index maior).
export function Hero() {
  return (
    <header className="fixed inset-0 z-0 flex flex-col justify-center overflow-y-auto px-6 py-20">
